...
public class XdsUpdateHealthServiceClient(
  ...
  public override suspend fun setServing(request: EmptyOuterClass.Empty, headers: Headers):
  ...
  public override suspend fun setNotServing(request: EmptyOuterClass.Empty, headers: Headers):
      ResponseMessage<EmptyOuterClass.Empty> = client.unary(
    request,
    headers,
    MethodSpec(

...
public class XdsUpdateClientConfigureServiceClient(
   ...
   */
  public override suspend fun configure(request: Messages.ClientConfigureRequest, headers: Headers):
      ResponseMessage<Messages.ClientConfigureResponse> = client.unary(
    request,
    headers,
    MethodSpec(
    "grpc.testing.XdsUpdateClientConfigureService/Configure",
      grpc.testing.Messages.ClientConfigureRequest::class,
      grpc.testing.Messages.ClientConfigureResponse::class,
    ),
  )
  ...
  public override fun configure(
    request: Messages.ClientConfigureRequest,
    headers: Headers,
    onResult: (ResponseMessage<Messages.ClientConfigureResponse>) -> Unit,

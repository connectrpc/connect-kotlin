...
class Generator : CodeGenerator {
    ...
    private fun parseFile(file: Descriptors.FileDescriptor): Map<ClassName, FileSpec> {
        ...
        for ((sourceInfo, service) in file.services.withSourceInfo(baseSourceInfo, FileDescriptorProto.SERVICE_FIELD_NUMBER)) {
            val interfaceFileSpec = FileSpec.builder(packageName, file.name)
                ...
                .addFileComment(sourceInfo.comment())
    ...
    private fun interfaceMethods(
        ...
        val headerParameterSpec = ParameterSpec.builder("headers", HEADERS_CLASS_NAME)
            ...
            .build()
        for ((sourceInfo, method) in methods.withSourceInfo(baseSourceInfo, DescriptorProtos.ServiceDescriptorProto.METHOD_FIELD_NUMBER)) {

...
.PHONY: lint
lint: ## Run lint.
	cd crosstests; buf lint
	cd examples; buf lint
	cd extensions; buf lint
...
releaselocal: ## Release artifacts to local maven repository.
	./gradlew --info :extensions:google-java:publishToMavenLocal --stacktrace
	./gradlew --info :extensions:google-javalite:publishToMavenLocal --stacktrace
	./gradlew --info :library:publishToMavenLocal --stacktrace
	./gradlew --info :okhttp:publishToMavenLocal --stacktrace

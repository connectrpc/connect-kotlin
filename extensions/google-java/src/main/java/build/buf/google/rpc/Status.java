...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return build.buf.google.rpc.StatusProto.internal_static_google_rpc_Status_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            build.buf.google.rpc.Status.class, build.buf.google.rpc.Status.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof build.buf.google.rpc.Status)) {
      return super.equals(obj);
    }
    build.buf.google.rpc.Status other = (build.buf.google.rpc.Status) obj;
  ...
  public static build.buf.google.rpc.Status parseFrom(
  ...
  public static build.buf.google.rpc.Status parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static build.buf.google.rpc.Status parseFrom(
  ...
  public static build.buf.google.rpc.Status parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static Builder newBuilder(build.buf.google.rpc.Status prototype) {
  ...
  public static final class Builder extends
      ...
      build.buf.google.rpc.StatusOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return build.buf.google.rpc.StatusProto.internal_static_google_rpc_Status_descriptor;
    }
    ...
    // Construct using build.buf.google.rpc.Status.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public build.buf.google.rpc.Status getDefaultInstanceForType() {
      return build.buf.google.rpc.Status.getDefaultInstance();
    }

    @java.lang.Override
    public build.buf.google.rpc.Status build() {
      build.buf.google.rpc.Status result = buildPartial();
    ...
    @java.lang.Override
    public build.buf.google.rpc.Status buildPartial() {
      build.buf.google.rpc.Status result = new build.buf.google.rpc.Status(this);
    ...
    private void buildPartialRepeatedFields(build.buf.google.rpc.Status result) {
      if (detailsBuilder_ == null) {
    ...
    private void buildPartial0(build.buf.google.rpc.Status result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof build.buf.google.rpc.Status) {
        return mergeFrom((build.buf.google.rpc.Status)other);
      } else {
    ...
    public Builder mergeFrom(build.buf.google.rpc.Status other) {
      if (other == build.buf.google.rpc.Status.getDefaultInstance()) return this;
      if (other.getCode() != 0) {
  ...
  private static final build.buf.google.rpc.Status DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new build.buf.google.rpc.Status();
  }

  public static build.buf.google.rpc.Status getDefaultInstance() {

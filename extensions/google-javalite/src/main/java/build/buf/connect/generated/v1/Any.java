...
public  final class Any extends
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        build.buf.connect.generated.v1.Any, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new build.buf.connect.generated.v1.Any();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<build.buf.connect.generated.v1.Any> parser = PARSER;
        if (parser == null) {
          synchronized (build.buf.connect.generated.v1.Any.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<build.buf.connect.generated.v1.Any>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }

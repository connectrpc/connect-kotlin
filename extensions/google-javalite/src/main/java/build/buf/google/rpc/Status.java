...
public  final class Status extends
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        build.buf.google.rpc.Status, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new build.buf.google.rpc.Status();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<build.buf.google.rpc.Status> parser = PARSER;
        if (parser == null) {
          synchronized (build.buf.google.rpc.Status.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<build.buf.google.rpc.Status>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }

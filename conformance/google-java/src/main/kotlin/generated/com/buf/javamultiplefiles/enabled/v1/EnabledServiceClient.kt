...
public class EnabledServiceClient(
  ...
  public override fun enabledBlocking(request: EnabledRequest, headers: Headers):
      UnaryBlockingCall<EnabledResponse> = client.unaryBlocking(
    request,
    headers,
    MethodSpec(
    "buf.javamultiplefiles.enabled.v1.EnabledService/Enabled",

...
public class DisabledServiceClient(
  ...
  public override suspend fun disabled(request: DisabledRequest, headers: Headers):
      ResponseMessage<DisabledResponse> = client.unary(
    request,
    headers,
    MethodSpec(
    "buf.javamultiplefiles.disabled.v1.DisabledService/Disabled",
      com.buf.javamultiplefiles.disabled.v1.DisabledRequest::class,
      com.buf.javamultiplefiles.disabled.v1.DisabledResponse::class,
    ),
  )
  ...
  public override fun disabled(
    ...
    headers: Headers,
    onResult: (ResponseMessage<DisabledResponse>) -> Unit,
  ...
  public override fun disabledBlocking(request: DisabledRequest, headers: Headers):
      UnaryBlockingCall<DisabledResponse> = client.unaryBlocking(
    request,
    headers,
    MethodSpec(
    "buf.javamultiplefiles.disabled.v1.DisabledService/Disabled",

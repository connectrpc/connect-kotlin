 ...
 */
public class XdsUpdateHealthServiceClient(
  private val client: ProtocolClientInterface,
) : XdsUpdateHealthServiceClientInterface {
  public override suspend fun setServing(request: Empty, headers: Headers): ResponseMessage<Empty> =
      client.unary(
    request,
    headers,
    MethodSpec(
  ...
  public override fun setServing(
    request: Empty,
    headers: Headers,
  ...
  public override fun setServingBlocking(request: Empty, headers: Headers): UnaryBlockingCall<Empty>
  ...
  public override suspend fun setNotServing(request: Empty, headers: Headers):
  ...
  public override fun setNotServing(
    request: Empty,
    headers: Headers,
    onResult: (ResponseMessage<Empty>) -> Unit,
  ): Cancelable = client.unary(
  ...
  public override fun setNotServingBlocking(request: Empty, headers: Headers):

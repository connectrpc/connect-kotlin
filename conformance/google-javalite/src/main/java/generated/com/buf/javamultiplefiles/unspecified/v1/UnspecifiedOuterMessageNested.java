...
public  final class UnspecifiedOuterMessageNested extends
    com.google.protobuf.GeneratedMessageLite<
        UnspecifiedOuterMessageNested, UnspecifiedOuterMessageNested.Builder> implements
  ...
  public  static final class InnerMessage extends
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageLite.Builder<
          com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested.InnerMessage, Builder> implements
    ...
    protected final java.lang.Object dynamicMethod(
      ...
      switch (method) {
        case NEW_MUTABLE_INSTANCE: {
          return new com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested.InnerMessage();
        }
        case NEW_BUILDER: {
          return new Builder();
        }
        ...
        case GET_PARSER: {
          com.google.protobuf.Parser<com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested.InnerMessage> parser = PARSER;
          if (parser == null) {
            synchronized (com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested.InnerMessage.class) {
              parser = PARSER;
              if (parser == null) {
                parser =
                    new DefaultInstanceBasedParser<com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested.InnerMessage>(
                        DEFAULT_INSTANCE);
                PARSER = parser;
              }
            }
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested> parser = PARSER;
        if (parser == null) {
          synchronized (com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.buf.javamultiplefiles.unspecified.v1.UnspecifiedOuterMessageNested>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    UnspecifiedOuterMessageNested defaultInstance = new UnspecifiedOuterMessageNested();
    // New instances are implicitly immutable so no need to make
    // immutable.
    DEFAULT_INSTANCE = defaultInstance;
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      UnspecifiedOuterMessageNested.class, defaultInstance);
  }
  ...
  private static volatile com.google.protobuf.Parser<UnspecifiedOuterMessageNested> PARSER;

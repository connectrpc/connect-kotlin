...
class JavaLiteHelpers {
    companion object {
        ...
        fun serializationStrategy(codec: ClientCompatRequest.Codec): SerializationStrategy {
            return when (codec) {
                ClientCompatRequest.Codec.PROTO -> GoogleJavaLiteProtobufStrategy()
                ClientCompatRequest.Codec.JSON -> throw RuntimeException("Java Lite does not support JSON")
            }
        }
